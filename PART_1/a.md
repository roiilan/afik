...
Inside those files, I provided instructions describing how I wanted to work with the AI. The main idea was to break the task into small steps called **PLANs**.

Based on my prompts, Copilot helped formulate each PLAN. To improve focus and accuracy, I instructed Copilot to ask clarifying questions whenever needed and wait for my response before continuing. It also generated implementation steps for each PLAN and waited for my approval before proceeding.
...
Inside each PLAN, I tried to include a summary of my prompts and interactions with Copilot under **HISTORY**. In parallel, I also used ChatGPT directly and made some manual corrections, so not every single action appears there. -->
...
Using those instructions, Copilot Agent generated PLANs. For each PLAN, I reviewed the logic and suggest implementation steps carefully. I approved a PLAN only after I was satisfied that the logic was good. The implementation was carried out only after I approved it. I also answered Copilot’s clarifying questions whenever necessary in order to improve its understanding and make the next steps more accurate.
...
I read ChatGPT’s comments carefully, asked follow-up questions where something was unclear, and chose to focus mainly on the issues I considered material.
